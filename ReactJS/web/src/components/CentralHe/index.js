...
import manometer_amarelo from '../../assets/manometer_amarelo.png';
...
function CentralHe (PatualHe1, PatualHe2, helioNow_1, helioNow_2, GAS11, id, AlarmeHe10, props) {
        ...
        <S.ContainerHe>
          ...
          {PatualHe2 >= 1  &&  <S.HE1002><img src= {HE05} alt="HE05_1" />  </S.HE1002> }
           ...
           <S.UNIDADE_PressaoAtual_Helio_Cilindro_2><h2>bar</h2></S.UNIDADE_PressaoAtual_Helio_Cilindro_2>
            ...
            <S.MANOMETER>
              <a href={'/Manometers'} onClick={() => {goToManometer()
