...
function CentralHe(PatualHe1, PatualHe2, GAS11, id, AlarmeHe10, props) {
  ...
  const windowSize = useRef([window.innerWidth, window.innerHeight]); // valores usados apenas para testes de css
  ...
  return (
    <S.ContainerHe>
      <S.CENTRALHE>
        ...
        {PatualHe1 >= 190 && (
          <S.HE1001>
            <img src={HE100} alt="HE100_1" />{" "}
          </S.HE1001>
        )}
        {PatualHe1 >= 180 && (
          <S.HE1001>
            <img src={HE95} alt="HE95_1" />{" "}
          </S.HE1001>
        )}
        {PatualHe1 >= 170 && (
          <S.HE1001>
            <img src={HE90} alt="HE90_1" />{" "}
          </S.HE1001>
        )}
        {PatualHe1 >= 160 && (
          <S.HE1001>
            <img src={HE85} alt="HE85_1" />{" "}
          </S.HE1001>
        )}
        {PatualHe1 >= 150 && (
          <S.HE1001>
            <img src={HE80} alt="HE80_1" />{" "}
          </S.HE1001>
        )}
        {PatualHe1 >= 140 && (
          <S.HE1001>
            <img src={HE75} alt="HE75_1" />{" "}
          </S.HE1001>
        )}
        {PatualHe1 >= 130 && (
          <S.HE1001>
            <img src={HE70} alt="HE70_1" />{" "}
          </S.HE1001>
        )}
        {PatualHe1 >= 120 && (
          <S.HE1001>
            <img src={HE65} alt="HE65_1" />{" "}
          </S.HE1001>
        )}
        {PatualHe1 >= 110 && (
          <S.HE1001>
            <img src={HE60} alt="HE60_1" />{" "}
          </S.HE1001>
        )}
        {PatualHe1 >= 100 && (
          <S.HE1001>
            <img src={HE55} alt="HE55_1" />{" "}
          </S.HE1001>
        )}
        {PatualHe1 >= 90 && (
          <S.HE1001>
            <img src={HE50} alt="HE50_1" />{" "}
          </S.HE1001>
        )}
        {PatualHe1 >= 80 && (
          <S.HE1001>
            <img src={HE45} alt="HE45_1" />{" "}
          </S.HE1001>
        )}
        {PatualHe1 >= 70 && (
          <S.HE1001>
            <img src={HE40} alt="HE40_1" />{" "}
          </S.HE1001>
        )}
        {PatualHe1 >= 60 && (
          <S.HE1001>
            <img src={HE35} alt="HE35_1" />{" "}
          </S.HE1001>
        )}
        {PatualHe1 >= 50 && (
          <S.HE1001>
            <img src={HE30} alt="HE30_1" />{" "}
          </S.HE1001>
        )}
        {PatualHe1 >= 40 && (
          <S.HE1001>
            <img src={HE25} alt="HE25_1" />{" "}
          </S.HE1001>
        )}
        {PatualHe1 >= 30 && (
          <S.HE1001>
            <img src={HE20} alt="HE20_1" />{" "}
          </S.HE1001>
        )}
        {PatualHe1 >= 20 && (
          <S.HE1001>
            <img src={HE15} alt="HE15_1" />{" "}
          </S.HE1001>
        )}
        {PatualHe1 >= 10 && (
          <S.HE1001>
            <img src={HE10} alt="HE10_1" />{" "}
          </S.HE1001>
        )}
        {PatualHe1 >= 1 && (
          <S.HE1001>
            <img src={HE05} alt="HE05_1" />{" "}
          </S.HE1001>
        )}
        ...
        <S.PressaoAtualHelioCilindro1>
          <h2>EM USO</h2>
        </S.PressaoAtualHelioCilindro1>

        <S.VALOR_PressaoAtual_Helio_Cilindro_1>
          {" "}
          <h2>{PatualHe1}</h2>
        </S.VALOR_PressaoAtual_Helio_Cilindro_1>

        <S.UNIDADE_PressaoAtual_Helio_Cilindro_1>
          <h2>bar</h2>
        </S.UNIDADE_PressaoAtual_Helio_Cilindro_1>

        <S.bellHe1>
          <img src={bellHe} alt="Alarme 1 Hélio"></img>
        </S.bellHe1>
        ...
        <S.PressaoAtualHelioCilindro2>
          <h2>RESERVA</h2>
        </S.PressaoAtualHelioCilindro2>

        <S.VALOR_PressaoAtual_Helio_Cilindro_2>
          <h2>{PatualHe2}</h2>
        </S.VALOR_PressaoAtual_Helio_Cilindro_2>

        <S.UNIDADE_PressaoAtual_Helio_Cilindro_2>
          <h2>bar</h2>
        </S.UNIDADE_PressaoAtual_Helio_Cilindro_2>

        <S.bellHe2>
          <img src={bellHe} alt="Alarme 2 Hélio"></img>
        </S.bellHe2>
      ...
      <S.MANOMETER>
        ...
        >
          <span className="featuredManometer">
            <h2>central</h2>{" "}
            <img
              src={manometer_vermelho}
              alt="manômetro vermelho"
              className="featuredIconLogo"
            />
          </span>
        </a>
        <a href={"/Manometers"}>
          <span className="featuredManometer1">
            <h2>lab</h2>{" "}
            <img
              src={manometer_vermelho}
              alt="manômetro vermelho"
              className="featuredIconLogo1"
            />
          </span>
        </a>
      </S.MANOMETER>
