...
{/*ESCALA EM PSI      */}
          {gaugePSIline.ticks.map((angle) => {
            ...
            //const showText = asValue === 0 || asValue === 100 || asValue === 200 || asValue === 300 || asValue === 400;
            const showTextPl = asValuePl === 0 || asValuePl === 967 || asValuePl === 1933 || asValuePl === 2900 || asValuePl === 3867 || asValuePl === 4833 || asValuePl === 5800;
         ...
         {gaugePSI.ticks.map((angle) => {
            ...
            //const showText = asValue === 0 || asValue === 100 || asValue === 200 || asValue === 300 || asValue === 400;
            const showTextP =  asValueP === 0 ||asValueP === 967 || asValueP === 1933 || asValueP === 2900 || asValueP === 3867 || asValueP === 4833 || asValueP === 5800;
        ...
        <text x="20" y="60" >
        <a href ='/manometers' > <tspan x="-48" y="-55" fontSize={36}>Hélio</tspan></a>
