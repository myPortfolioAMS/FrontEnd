  ...
  return (
    <div className="p-4">
      <svg className="w-full overflow-visible p-2" {...gaugeBAR.getSVGProps()}>
            ...
            return (
              <React.Fragment key={`tick-group-${angle}`}>
                <line
                  ...
                  strokeWidth={2}
                  {...gaugeBARline.getTickProps({
                    angle,
                    length: showTextPl ? 12 : 6,
                  })}
                />
              </React.Fragment>
            );
            ...
            return (
              <React.Fragment key={`tick-group-${angle}`}>
                <line
                  className="stroke-gray-300"
                  strokeWidth={2}
                  {...gaugeBARtext.getTickProps({
                    angle,
                    length: showTextx ? 12 : 6,
                  })}
                />
                {showTextx && (
                  <text
            ...
            return (
              <React.Fragment key={`tick-group-${angle}`}>
                <line
                  className="stroke-red-300"
                  strokeWidth={2}
                  {...gaugePSI.getTickProps({
                    angle,
                    length: showTextP ? 2 : 1,
                  })}
                />
                {showTextP && (
                  <text
        ...
        <text x="20" y="60">
          <tspan x="-105" y="150" fontSize={28}>
            {PatualHe1} bar /{" "}
          </tspan>
        </text>

        <text x="20" y="60">
          <tspan x="10" y="150" fontSize={28} fill="#FF0000">
            {" "}
            {PatualHe1_PSI} PSI
          </tspan>
        </text>
        ...
        <text x="20" y="60">
          <tspan x="-8" y="220" fontSize={24} fill=" #7d3c98 ">
            {AlarmeHe10} bar
          </tspan>
        </text>
