...
const loginAPIUrl =
  " https://hsmsl98l5h.execute-api.sa-east-1.amazonaws.com/prod/login";
...
const Login = (props) => {
  ...
  const submitHandler = (event) => {
    ...
    if (username.trim() === "" || password.trim() === "") {
      setErrorMessage("Necessário preeencher o campo de usuário e senha");
      return;
    }
    ...
    axios
      ...
      .catch((error) => {
        if (
          ...
          setErrorMessage(
            "Erro no processo de login. Por favor, tente novamente mais tarde."
          );
        }
      });
  };
    ...
    <div>
      <S.Container>
        ...
        <S.Footer>
          ...
          <h2>
            Width: {windowSize.current[0]} x Height: {windowSize.current[1]} -
            r. 53_6
          </h2>
        </S.Footer>

        <S.BottomScreen>
          <S.ScreenSize_1></S.ScreenSize_1>

          <S.ScreenSize_2></S.ScreenSize_2>
